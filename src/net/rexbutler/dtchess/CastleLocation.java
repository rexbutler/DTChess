...
public enum CastleLocation {
    ...
    WHITE_KING_SIDE(
            ...
            new Move(new Square(7, 0), new Square(5, 0))
    ),
    ...
    WHITE_QUEEN_SIDE(
            ...
            new Move(new Square(0, 0), new Square(3, 0))
    ),
    ...
    BLACK_KING_SIDE(
            ...
            new Move(new Square(7, 7), new Square(5, 7))
    ),
    ...
    BLACK_QUEEN_SIDE(
            ...
            new Move(new Square(0, 7), new Square(3, 7))
    );
    // @formatter:on
